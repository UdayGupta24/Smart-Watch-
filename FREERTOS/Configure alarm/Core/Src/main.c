...
/* USER CODE BEGIN PV */
xTaskHandle xHandlecmd_handler;
xTaskHandle xHandlemenu;
xTaskHandle xHandleprint_task ;
xTaskHandle xHandlealarm_task;

xQueueHandle q_print;
xQueueHandle q_enqueue;
...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
    ...
    //TaskHandle_t startSYSVIEW_handle = NULL;
  /* USER CODE END 1 */
